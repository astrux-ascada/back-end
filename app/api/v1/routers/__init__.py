...
from app.identity import api_marketing # <-- Marketing
...
from app.reporting import api as reporting_api # <-- Reporting
from app.payments import api as payments_api # <-- Payments
...
saas_router.include_router(saas_api.router)
saas_router.include_router(api_marketing.client_router) # Marketing Cliente
saas_router.include_router(payments_api.router) # Pagos Cliente
...
ops_router.include_router(reporting_api.router, dependencies=[Depends(require_feature("module_reporting"))]) # <-- Reporting
...
sys_mgt_router.include_router(api_marketing.admin_router) # Marketing Admin

# Montamos el router de identidad para super admins
