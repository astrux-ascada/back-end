...
from app.sectors import api as sectors_api # Añadido el nuevo router
...
api_router.include_router(sectors_api.router) # El prefijo "/sectors" ya está en el router
