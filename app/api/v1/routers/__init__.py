...
from app.identity import api_roles as identity_roles_api # <-- 1. IMPORTAR
...
api_router.include_router(identity_api.router) # Endpoints de /auth (login, me, users)
api_router.include_router(identity_roles_api.router) # <-- 2. INCLUIR (Endpoints de /identity (roles, permissions))
