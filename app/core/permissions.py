...
TENANT_UPDATE = "tenant:update" # Para actualizar datos del tenant
...
ASSET_DELETE = "asset:delete" # Solicitar borrado (Maker-Checker)
...
# --- Permisos de Sesión ---
SESSION_DELETE = "session:delete" # Para cerrar todas las sesiones de un usuario
